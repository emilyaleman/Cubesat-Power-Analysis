...
class Orbit:
    def __init__(self, altitude_km, inclination_deg=None, is_sso=False):
        ...
        # También puedes calcular el periodo de una vez si quieres:
...
#     def __init__(self, satellite, orbit, RAAN_deg, sun_vector, nadir_condition, nadir_face):
#         self.sat = satellite
#         self.orbit = orbit
#         self.inclination = orbit.inclination
#         self.RAAN = radians(RAAN_deg)
...
#         if nadir_condition and nadir_face in base_normals:
#             v1 = base_normals[nadir_face]
#             v2 = np.array([0, 0, -1])  # Nadir always points -Z in LVLH
#             R = self._rotation_matrix_from_vectors(v1, v2)
#             self.rotated_normals = {face: R @ vec for face, vec in base_normals.items()}
#         else:
#             self.rotated_normals = base_normals
...
#         total_power = 0
#         power_per_face = {}
#         face_normals = self.rotated_normals
